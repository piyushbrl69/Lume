...
export default function ToolsPage() {
  ...
  return (
    <main className="p-4 sm:p-6 md:p-8 w-full min-h-screen space-y-8 sm:space-y-12">
      <header>
      ...
      {/* Add New Tool Form */}
      <section className="bg-white dark:bg-slate-900 p-4 sm:p-6 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-sm max-w-2xl">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
          {tools.map(tool => (
            <a
              ...
              className="group relative bg-white dark:bg-slate-900 rounded-3xl p-4 sm:p-6 border border-slate-200 dark:border-slate-800 hover:border-indigo-400 dark:hover:border-indigo-600 hover:shadow-md transition-all flex flex-col items-center justify-center gap-3 sm:gap-4 aspect-square"
            >
      ...
      <section className="pt-6 border-t border-slate-200 dark:border-slate-800 space-y-6">
        ...
        {statusMessage && (
          <div className={`p-4 rounded-2xl border text-sm font-medium flex items-center gap-3 max-w-2xl ${
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl">
          ...
          <div className="bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-sm flex flex-col justify-between">
            ...
            <label className="w-full bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-800 dark:text-white font-bold py-3 rounded-xl flex items-center justify-center gap-2 transition-colors text-sm cursor-pointer text-center">
